// Kører hver artboards logik-blok i en sandkasse og sammenholder de værdier
// renderVals() faktisk leverer med de {{huller}} skabelonen beder om.
import { readFileSync } from 'node:fs';
import vm from 'node:vm';

const FILER = ['Main', 'Start', 'Lobby', 'Kort', 'Meier', 'MeierTilskuer', 'Taarn', 'MobilSpil', 'MobilStart', 'MobilKort'];
